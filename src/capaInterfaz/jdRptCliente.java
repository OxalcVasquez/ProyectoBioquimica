 ...
 * @author CMFerrer
 */
public class jdRptCliente extends javax.swing.JDialog {

    /**
     * Creates new form jdRptCliente
     */
    public jdRptCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            JRViewer vistaRep = new clsReporte().reporteInterno("rptCliente.jasper", null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRptCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRptCliente dialog = new jdRptCliente(new javax.swing.JFrame(), true);
