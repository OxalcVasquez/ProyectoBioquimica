 ...
 * @author CMFerrer
 */
public class jdRptProductosPorMarca extends javax.swing.JDialog {

    /**
     * Creates new form jdRptProductosPorMarca
     */
    public jdRptProductosPorMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JRViewer vistaRep = new clsReporte().reporteInterno("rptProductosPorMarca.jasper", null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRptProductosPorMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRptProductosPorMarca dialog = new jdRptProductosPorMarca(new javax.swing.JFrame(), true);
