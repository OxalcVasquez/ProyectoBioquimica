 ...
 * @author Mashuk
 */
public class BotonMedGradiente extends JButton implements MouseListener {
     ...
     * we can use it as a value of parameter like as: BotonMedGradiente.TOP_LEFT_TO_BOTTOM_RIGHT which returns a int value 0.
     */
     ...
     * we can use it as a value of parameter like as: BotonMedGradiente.TOP_LEFT_TO_BOTTOM_RIGHT which returns a int value 1.
     */
     ...
     * we can use it as a value of parameter like as: BotonMedGradiente.TOP_LEFT_TO_BOTTOM_RIGHT which returns a int value 2.
     */
     ...
     * we can use it as a value of parameter like as: BotonMedGradiente.TOP_LEFT_TO_BOTTOM_RIGHT which returns a int value 3.
     */
     ...
     * @since 1.3
     */
    public BotonMedGradiente(Action a) {
        super(a);
     ...
     */
    public BotonMedGradiente(Icon icon) {
        super(icon);
        this.color1 = DEFAULT_COLOR_1;
        this.color2 = DEFAULT_COLOR_2;
        this.align = DEFAULT_ALIGN;
     ...
     */
    public BotonMedGradiente(String text) {
        super(text);
        this.color1 = DEFAULT_COLOR_1;
        this.color2 = DEFAULT_COLOR_2;
        this.align = DEFAULT_ALIGN;
     ...
     * @param icon the Icon image to display on the button
     */
    public BotonMedGradiente(String text, Icon icon) {
        super(text, icon);
        this.color1 = DEFAULT_COLOR_1;
        this.color2 = DEFAULT_COLOR_2;
        this.align = DEFAULT_ALIGN;
     ...
     */
    public BotonMedGradiente(Color color1, Color color2, int align) {
        super();
        this.color1 = color1;
        this.color2 = color2;
        this.align = align;
     ...
     * @param icon the Icon image to display on the button
     */
    public BotonMedGradiente(Color color1, Color color2, int align, Icon icon) {
        super(icon);
        this.color1 = color1;
        this.color2 = color2;
        this.align = align;
     ...
     * @param text the text of the button
     */
    public BotonMedGradiente(Color color1, Color color2, int align, String text) {
        super(text);
        this.color1 = color1;
        this.color2 = color2;
        this.align = align;
     ...
     * @param icon the Icon image to display on the button
     */
    public BotonMedGradiente(Color color1, Color color2, int align, String text, Icon icon) {
        super(text, icon);
        this.color1 = color1;
        this.color2 = color2;
        this.align = align;
