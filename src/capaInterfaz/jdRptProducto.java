 ...
 * @author CMFerrer
 */
public class jdRptProducto extends javax.swing.JDialog {

    /**
     * Creates new form jdRptCliente
     */
    public jdRptProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            JRViewer vistaRep = new clsReporte().reporteInterno("rptProductos.jasper", null);
            contenedor.add(vistaRep);
            this.visorReporte.setVisible(true);
        } catch (Exception ex) {
            Logger.getLogger(jdRptProducto.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRptProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRptProducto dialog = new jdRptProducto(new javax.swing.JFrame(), true);
