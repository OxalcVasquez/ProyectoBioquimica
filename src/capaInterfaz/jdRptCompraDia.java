...
public class jdRptCompraDia extends javax.swing.JDialog {
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
          try {
            ...
            JRViewer vistaRep = new clsReporte().reporteInterno("rptComprasDia.jasper",param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRptCompraDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRptCompraDia dialog = new jdRptCompraDia(new javax.swing.JFrame(), true);
