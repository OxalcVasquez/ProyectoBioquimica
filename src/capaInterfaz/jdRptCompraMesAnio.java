...
public class jdRptCompraMesAnio extends javax.swing.JDialog {
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
        try {
            ...
            JRViewer vistaRep = new clsReporte().reporteInterno("rptComprasMesAnio.jasper", param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRptCompraMesAnio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRptCompraMesAnio dialog = new jdRptCompraMesAnio(new javax.swing.JFrame(), true);
