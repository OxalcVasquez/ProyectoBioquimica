 ...
 */
public class jdVerReportes extends javax.swing.JDialog {
    ...
    public jdVerReportes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JRViewer vistaRep = new clsReporte().reporteInterno(nombreReporte,null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdVerReportes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdVerReportes dialog = new jdVerReportes(new javax.swing.JFrame(), true);
